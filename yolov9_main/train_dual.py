...
def train_dual_opt(data, weights, epochs, batch_size=16, imgsz=640,known=False):
    parser = argparse.ArgumentParser()

    # Required Arguments
    parser.add_argument('--weights', type=str, default=weights, help='initial weights path')
    parser.add_argument('--cfg', type=str, default='D:/obj_detec/yolov9_main/models/detect/yolov9-c.yaml', help='model.yaml path')
    ...
    parser.add_argument('--batch-size', type=int, default=batch_size, help='batch size for all GPUs')
    parser.add_argument('--imgsz', type=int, default=imgsz, help='train, val image size (pixels)')

    # Other Arguments (copied from `parse_opt`)
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='D:/obj_detec/yolov9_main/weights/yolov9-c.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='D:/obj_detec/yolov9_main/models/detect/yolov9-c.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'D:/obj_detec/yolov9_main/data/yolo.yaml', help='dataset.yaml path')
...
def run(**kwargs):
    ...
    #opt = train_dual_opt()
    opt = train_dual_opt(
        data=kwargs.get("data", "coco128.yaml"),
        weights=kwargs.get("weights", "yolo.pt"),
...
if __name__ == "__main__":
    opt = train_dual_opt(data=r"D:\obj_detec\YOLO_DATA\yolo_dataset.yaml", 
